import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, getCurrentInstance, defineComponent, ref, inject, h, Suspense, Fragment, useSSRContext, createApp, provide, shallowReactive, mergeProps, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, getCurrentScope, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { o as parseURL, f as encodePath, q as decodePath, t as hasProtocol, v as isScriptProtocol, w as joinURL, x as withQuery, y as sanitizeStatusCode, z as getContext, $ as $fetch, A as baseURL, c as createError$1, B as executeAsync, C as getHeader, D as setCookie, E as setHeader, F as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "confirm",
    path: "/confirm",
    component: () => import('./confirm-B8HDzfJ5.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: { "middleware": ["guest"] },
    component: () => import('./login-BxlyzCrD.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: { "middleware": ["auth"] },
    component: () => import('./index-QqGXwe9N.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-CgvtHyVG.mjs'),
  guest: () => import('./guest-C9rCKIkp.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CZf-Uewe.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-ZeO0GoDU.mjs'));
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useSupabaseUser as d, entry_default as default, encodeRoutePath as e, useState as f, defineNuxtRouteMiddleware as g, navigateTo as n, resolveRouteObject as r, useRouter as u };
